...
const navigation = {
  ...
  products: [
    { name: "Thép xây dựng", href: "/products/thep-xay-dung" },
    { name: "Thép ống - hộp - vuông", href: "/products/thep-ong-hop-vuong" },
    { name: "Thép hình", href: "/products/thep-hinh" },
    { name: "Tôn", href: "/products/ton" },
    { name: "Lưới - xà gồ - phụ kiện", href: "/products/luoi-xa-go-phu-kien" },
    { name: "Hộp - ống inox", href: "/products/hop-ong-inox" },
  ],
};
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-start space-x-3">
                ...
                >
                  1602, Ấp Ngọc Lâm 4, Xã Phú Thanh, Huyện Tân Phú, Tỉnh Đồng Nai
                </Link>
              </div>
